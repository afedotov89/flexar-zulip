...
- ✅ **2.1+2.2** — Compose-бокс + send (POST /messages, оптимистичное
  эхо, реконсиляция). **Live-протык на стенде: сообщение отправлено и
  появилось в ленте.** 680 unit-тестов.
- **2.3 Typeahead** ← следующее. `@упоминания`, `#каналы`, `:эмодзи:`,
  топики.
- **2.4 Черновики** — автосохранение, список, восстановление.

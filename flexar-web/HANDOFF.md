...
**Следующее — Фаза 3** (PRD §8 ФАЗА 3): поиск, реакции,
действия над сообщением (редактирование/удаление/move/star/quote-reply),
управление непрочитанным, уведомления, эмодзи-пикер + custom realm
emoji.
